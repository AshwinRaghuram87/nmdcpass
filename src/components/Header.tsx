      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 border-b border-slate-800/80">
        <div className="flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center space-x-3 text-slate-300">
            ...
            <span className="text-slate-600">|</span>
            <span className="text-amber-300 font-bold">Client: NMDC , Donimalai</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-lg sm:text-xl font-bold tracking-tight text-white">
                  Amnex <span className="text-blue-400 font-bold">| NMDC , Donimalai</span>
                </h1>
                <span className="bg-blue-500/20 text-blue-300 text-[10px] sm:text-[11px] font-semibold px-2 py-0.5 rounded border border-blue-500/30">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {/* Detailed Passes Report (RGP vs NRGP) */}
            <button
              id="btn-open-report"
              onClick={onOpenReportModal}
              title="Open detailed Report of passes issued with separation for Returnable (RGP) and Non-Returnable (NRGP)"
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white border border-indigo-400/40 transition shadow-2xs cursor-pointer"
            >
              <FileText className="w-3.5 h-3.5" />
              <span>Passes Report (RGP/NRGP)</span>
            </button>
